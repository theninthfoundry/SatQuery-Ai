...
def route_query(question: str, context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    aoi_id / image_id / image_before_id / image_after_id / object_class /
    change_job_id. The router only forwards the fields the chosen tool
    actually declares in its input_schema.
    """
